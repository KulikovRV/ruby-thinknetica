    ...
    loop do
      ...
      when '6'
        ...
        if user_train.is_a?(CargoTrain)
          ...
          puts 'Поезду не прицепить вагон, так как не совпадает ' \
               'тип поезда и вагона.'
        end

      when '7'
        return puts 'Еще не создан ни один поезд!' if @trains.empty?
      ...
      when '8'
        ...
        return puts 'У поезда нет маршрута!' if user_train.route.nil?
        ...
        user_manipulation = gets.chomp.downcase
        ...
        when 'showprevious'
          ...
          puts "Ошибка ввода, нет такой команды #{user_manipulation}."
        end
        ...
        begin
          if @vagons.empty?
            ...
            if user_vagon.type == 'cargo'
              ...
              puts 'В вагоне заняли одно место, ' \
                   "осталось #{user_vagon.count_empty_seats}."
            else
